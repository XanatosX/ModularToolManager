...
If you want to improve the translation use this [link](https://crowdin.com/project/modular-tool-manager) to Crowdin.
If you want to add an addition language, please create an issue I will inform you as soon as you can start translating via Crowdin.
