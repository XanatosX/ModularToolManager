...
namespace ModularToolManager.Services.IO
{
    ...
    internal interface ISerializeService
    {
        ...
        /// <param name="data">The data object to serialize</param>
        /// <returns>The serialized object as a string</returns>
        async Task<string> GetSerializedAsync<T>(T data) where T : class => await Task.Run(() => GetSerialized<T>(data));
        ...
        /// <param name="data">The data object to serialize</param>
        /// <returns>The serialized object as a stream</returns>
        async Task<Stream> GetSerializedStreamAsync<T>(T data) where T : class => await Task.Run(() => GetSerializedStream<T>(data));
